...
# base model = data augmentation, drouput, batch normalization
test_img_folder =       '/home/matias/Documents/nn/test'
base_model_path =       '/home/matias/Documents/cnn_saved_models/project1_part3.tf'
inception_model_path =  '/home/matias/Documents/cnn_saved_models/project1_part3_inception.tf'
resnet_model_path =     '/home/matias/Documents/cnn_saved_models/project1_part3_resnet.tf'
...
# print(len(base_results), len(inception_results), len(resnet_results)) # debug
# sum the results and take the average
ensemble_results = np.array(base_results) + np.array(base_results) + np.array(resnet_results)
ensemble_results/=3

# ENSEMBLE PRDICTION - ENSEMBLE PRDICTION - ENSEMBLE PRDICTION - ENSEMBLE PRDICTION - ENSEMBLE PRDICTION -
